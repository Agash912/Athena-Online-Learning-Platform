 ...
 * @author manish
 */
public class Stu_view_course_curriculum extends javax.swing.JPanel {

    /**
     * Creates new form view_coursedetails
     */
    ...
    public Stu_view_course_curriculum(JPanel bottom_panel, Student_details_list students, Professor_details_list professors, Course_details_list courses,Student_details student_details,ArrayList<Object> coursePair) {
        initComponents();
        ...
        txtfield.setText(Course.getSyllabus());
    ...
    private void initComponents() {
        ...
        add(jLabel7);
        jLabel7.setBounds(6, 6, 1642, 44);

        jLabel1.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
        jLabel1.setText("Course Curriculum");
        add(jLabel1);
        jLabel1.setBounds(730, 210, 151, 17);
        ...
        add(btn_back);
        btn_back.setBounds(760, 490, 82, 32);

        txtfield.setEditable(false);
        add(txtfield);
        txtfield.setBounds(540, 240, 517, 150);
